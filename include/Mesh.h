...
class Mesh{
    ...
    void Draw(MTL::RenderCommandEncoder * encoder, MTL::RenderPipelineState * Rpso, MTL::DepthStencilState * DSO, PBRMaterial pbr_mat ,PBR_COLOR pbr_color,MTL::Buffer * transformationBuffer);
